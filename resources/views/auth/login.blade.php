...
<body>
    ...
    <!-- Page -->
    <div class="bg-transparent container-xxl d-flex flex-column align-items-center justify-content-center" style="height: calc(100vh - 56px)">
        ...
        <form method="POST" action="{{ route('login')}}">
            ...
            <div class="mb-3">
                ...
                <div id="passwordHelp" class="form-text">Don't have an account? <a href="{{route('register')}}">Register</a></div>
            </div>
