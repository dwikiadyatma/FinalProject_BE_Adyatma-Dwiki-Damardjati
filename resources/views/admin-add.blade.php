...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">LaraShop Katalog</a>
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="{{route('add')}}">Masukan Barang</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="container-xxl d-flex flex-column align-items-center justify-content-center" style="height: calc(100vh - 56px)">
        <h1 class="display-6 text-center">Masukan detail barang</h1>
        ...
        <form method="POST" action="{{ route('add_item') }}" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                <label for="itemNumber" class="form-label">Jumlah Barang</label>
